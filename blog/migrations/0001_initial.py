    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expert', models.TextField(null=True, verbose_name='Рецензия')),
                ...
                ('category', models.ForeignKey(default='Без категории', on_delete=django.db.models.deletion.SET_DEFAULT, to='blog.category')),
            ],
            options={
                'ordering': ('-published',),
            },
